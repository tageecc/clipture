...
## Is Clipture open source?

No. This repository is public for releases, documentation, and feedback. The application source code remains proprietary and private.

## Does Clipture support Intel Macs?
...
这个仓库用于分发安装包、维护文档和收集反馈。Clipture 的源代码仍然是专有代码并保存在私有仓库中。
