<p align="center">
  <img src="docs/icon.png" width="96" height="96" alt="Clipture 应用图标">
</p>
...
<p align="center">
  <a href="https://clipture.talkape.net/assets/clipture-demo-v7.mp4">
    <img src="docs/demo-poster.jpg" alt="Clipture 功能演示" width="900">
  </a>
</p>

Clipture 把常用屏幕捕获工具和本地剪贴板历史放在一个桌面应用里。它可以截取选区或窗口、生成滚动长图、添加标注、在本地识别文字、把截图置顶，并搜索之前复制的文本、图片和文件；macOS 版还支持把选区录制为 MP4 或 GIF，并保留可再次编辑的截图历史。
...
- 本地文字识别，可直接选择截图中的文字
- 取色与截图置顶
- macOS 选区录屏，可导出 MP4 或动画 GIF
- macOS 可编辑截图历史，保留原图像素与标注图层
...
签名版 macOS 应用内置结构化 CLI 和 Codex Skill，支持截图、标注、当前剪贴板读写、可搜索的本地剪贴板历史、环境预检与可信安装；滚动截图、贴图、Live Text 和取色等交互能力继续通过应用界面使用。安装方式和 JSON 示例见 [AI Agent 接口](docs/agent.md)。
