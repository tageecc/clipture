...
- For display, window, or interactive capture, timed MP4/GIF recording, and reusable annotations, read [references/capture.md](references/capture.md).
